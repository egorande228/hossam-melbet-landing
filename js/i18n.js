...
const I18N = {
  eng: {
    ...
    index: {
      title: 'MelBet Partner Programs | Affiliate, Teamcash & E-Payment',
      description:
        'Explore MelBet partner programs for affiliates, Teamcash agents, and e-payment partners. Compare the options and apply through the official contact page.',
      topCta: 'Start Earning Today',
      heroKicker: 'MelBet Official Partnership',
      heroTitle: 'Join Melbet Partnerships Program',
      heroCopy:
        'Compare affiliate, Teamcash, and e-payment options, then apply through the official contact page for the partnership model that fits your experience.',
      heroButtons: ['Start Earning Today', 'Our Partnership Programs'],
      statsTitle: 'Quick Overview',
      stats: [
        '<strong>3</strong> partner program routes',
        '<strong>Apply</strong> on the contact page',
        '<strong>Telegram</strong> support link',
        '<strong>Digital</strong> payment route'
      ],
      programsKicker: 'Programs',
      programsTitle: 'Our Partnership Programs',
      programsCopy:
        'Compare the three partnership models below and choose the one that matches how you want to work with MelBet.',
      programs: [
        {
      ...
      faq: [
        {
          q: 'What is Melbet?',
          a: 'On this site, MelBet is presented through partnership programs for affiliates, Teamcash agents, and e-payment partners. The homepage is an overview page, and the contact form is the next step if you need current operational details.'
        },
        {
        ...
        },
        {
          ...
          a: 'The Affiliate Program is presented as a way to earn commissions by bringing new players to the MelBet platform. The overview published here lists 25% to 50% commission on player revenue through your promo code, plus an additional 3% for a master account model.'
        },
        {
          q: 'What is the Teamcash?',
          a: 'Teamcash is presented as a local cash deposit and withdrawal service for players in your region. The page describes it as agent work handled through the company app.'
        },
        {
          q: 'What is the E-Payment Program?',
          a: 'The E-Payment Program is presented for partners who handle digital payments and transfers for players. The overview says the role works with e-payment methods and includes access to technical support.'
        },
        {
          q: 'What is the Teamcash Program?',
          a: 'The Teamcash Program is described as a payment support role for your area. Agents help with local cash deposits and withdrawals and earn commissions on those transactions.'
        },
        {
          q: 'What is the CPA Program?',
          a: 'The overview says the CPA program pays a direct $10 bonus for each qualifying player you register. It is presented as a separate bonus alongside the standard affiliate commission structure.'
        },
        {
          q: 'Do you offer demo accounts for marketing?',
          a: 'This page says demo accounts ranging from $2,000 to $10,000 are available for marketing purposes. Use the contact page to confirm availability for your program.'
        },
        {
          q: 'What is the startup cost for becoming a Teamcash?',
          a: 'The Teamcash program card lists a low startup investment of $50 USD. Regional working details can be confirmed during the application process.'
        },
        {
          q: 'How do I work as a Teamcash agent?',
          a: 'The site presents Teamcash work through the company app. Agents process deposit and withdrawal requests for players in their area and receive commission on completed transactions.'
        },
        {
          q: 'What is the difference between a Teamcash and an E-Payment Agent?',
          a: 'Teamcash focuses on local cash deposit and withdrawal support, while the E-Payment Agent role focuses on digital transfers and online payment methods.'
        },
        {
          q: 'Which e-payment banks can I work with?',
          a: 'This overview does not publish a list of banks or providers. Use the contact form or Telegram link to confirm the supported payment methods for your country.'
        },
        {
          q: 'How and when do I receive my commissions?',
          a: 'The site explains that commissions depend on the partner model you choose, but it does not publish a full payout schedule on this page. Confirm payment timing and method during onboarding.'
        },
        {
          q: 'What withdrawal methods are available?',
          a: 'Available withdrawal and payment methods vary by program and region. The homepage presents Teamcash for local cash support and the e-payment route for digital methods.'
        },
        {
          q: 'How can I contact the partnerships team?',
          a: 'You can contact the partnerships team through the official contact page or the Telegram link shown on this site.'
        },
        {
          q: 'How long does the application approval process take?',
          a: 'The contact page says requests are reviewed and followed up on, typically within 24 hours. Timing can vary when additional review is needed.'
        }
      ],
      contactKicker: 'Contact',
      contactTitle: 'Ready to Start Earning With Melbet?',
      contactCopy1:
        'Compare the partner models on this page, then use the official application form to share your country, experience, and preferred program.',
      contactCopy2:
        'This overview is maintained by the MelBet Partnerships team. Current regional working terms are confirmed during the application review.',
    ...
    contact: {
      ...
      heroCopy:
        'Fill out the application form below. The MelBet Partnerships team reviews each request and follows up, typically within 24 hours.',
      labels: {
...
const applyIndex = (langData) => {
  ...
  setText('.hero-program-item:nth-child(3) strong', stats[3]?.value || 'Digital');
  ...
  setText('#contact .contact-grid > div p:nth-of-type(2)', t.contactCopy2);
